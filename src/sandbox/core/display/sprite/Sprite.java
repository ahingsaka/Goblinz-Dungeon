 ...
 * <p>
 * Create a Sprite from json data using
 * {@link SpriteLoader#getSprite(String json)}.
 * <p>
 * To use, add {@link #layer()} to a {@link Layer} in your game. To change
 * sprites, call {@link #setSprite(int)}.
 */
public class Sprite {
    ...
    private boolean imagesDone = false; // true when images have finished
                                        // loading
    ...
    /**
     * Set callback that will be called when both the sprite data and sprite
    ...
    /**
     * Return true when both the sprite data and the sprite image have been
     * loaded.
     * <p>
     * 
     ...
     * <p>
     * The index is an integer between 0 and the number of sprites (@see
     * {@link #numSprites()})
     */
    ...
    /**
     * Should be called when the sprite data and sprite image have been loaded.
     * Will handle calling the {@link ResourceCallback} of the {@link Sprite}.
     */
    void done() {
        if (callback != null) {
            callback.done(this);
    ...
    /**
     * Should be called if an error occurs when loading the sprite image or
     * data. Will handle calling the {@link ResourceCallback} of the
     * {@link Sprite}.
     */
